...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_fs_proxy_actor_impl {
    ($ty:ident) => {
...
#[doc(inline)]
pub(crate) use __export_fs_proxy_actor_impl as export;
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.36.0:ntwk:theater:fs-proxy-actor:encoded world"]
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 1130] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xe5\x07\x01A\x02\x01\
...
\x01\x06\x04\0\"ntwk:theater/message-server-client\x05\x09\x04\0\x1bntwk:theater\
/fs-proxy-actor\x04\0\x0b\x14\x01\0\x0efs-proxy-actor\x03\0\0\0G\x09producers\x01\
